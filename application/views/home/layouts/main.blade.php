		...
		<div class="container">
			<div class="row justify-content-between align-items-center">
				<div class="col-lg-4 col-md-4 col-sm-12 logo-left no-padding">
					<a href="index.html">
						<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/logo.png" alt="">
					</a>
				</div>
				<div class="col-lg-8 col-md-8 col-sm-12 logo-right no-padding ads-banner">
					<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/banner-ad.jpg" alt="">
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row small-gutters">
				<div class="col-lg-8 top-post-left">
					<div class="feature-image-thumb relative">
						...
						<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/top-post1.jpg" alt="">
					</div>
				...
				<div class="col-lg-4 top-post-right">
					<div class="single-top-post">
						<div class="feature-image-thumb relative">
							<div class="overlay overlay-bg"></div>
							<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/top-post2.jpg" alt="">
						</div>
						<div class="top-post-details">
							<ul class="tags">
								<li><a href="#">Food Habit</a></li>
					...
					<div class="single-top-post mt-10">
						<div class="feature-image-thumb relative">
							<div class="overlay overlay-bg"></div>
							<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/top-post3.jpg" alt="">
						</div>
						<div class="top-post-details">
							<ul class="tags">
								<li><a href="#">Food Habit</a></li>
				...
				<div class="col-lg-8 post-list">
					...
					<div class="latest-post-wrap">
						...
						<div class="single-latest-post row align-items-center">
							<div class="col-lg-5 post-left">
								<div class="feature-img relative">
									<div class="overlay overlay-bg"></div>
									<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/l1.jpg" alt="">
								</div>
								<ul class="tags">
						...
						<div class="single-latest-post row align-items-center">
							<div class="col-lg-5 post-left">
								<div class="feature-img relative">
									<div class="overlay overlay-bg"></div>
									<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/l2.jpg" alt="">
								</div>
								<ul class="tags">
						...
						<div class="single-latest-post row align-items-center">
							<div class="col-lg-5 post-left">
								<div class="feature-img relative">
									<div class="overlay overlay-bg"></div>
									<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/l3.jpg" alt="">
								</div>
								<ul class="tags">
						...
						<div class="single-latest-post row align-items-center">
							<div class="col-lg-5 post-left">
								<div class="feature-img relative">
									<div class="overlay overlay-bg"></div>
									<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/l4.jpg" alt="">
								</div>
								<ul class="tags">
					...
					<div class="popular-post-wrap">
						...
						<div class="feature-post relative">
							<div class="feature-img relative">
								<div class="overlay overlay-bg"></div>
								<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/f1.jpg" alt="">
							</div>
							<div class="details">
								<ul class="tags">
									<li><a href="#">Food Habit</a></li>
						...
						<div class="row mt-20 medium-gutters">
							<div class="col-lg-6 single-popular-post">
								<div class="feature-img-wrap relative">
									<div class="feature-img relative">
										<div class="overlay overlay-bg"></div>
										<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/f2.jpg" alt="">
									</div>
									<ul class="tags">
										<li><a href="#">Travel</a></li>
									</ul>
							...
							<div class="col-lg-6 single-popular-post">
								<div class="feature-img-wrap relative">
									<div class="feature-img relative">
										<div class="overlay overlay-bg"></div>
										<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/f3.jpg" alt="">
									</div>
									<ul class="tags">
										<li><a href="#">Travel</a></li>
									</ul>
						...
						<div class="relavent-story-list-wrap">
							<div class="single-relavent-post row align-items-center">
								<div class="col-lg-5 post-left">
									<div class="feature-img relative">
										<div class="overlay overlay-bg"></div>
										<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/r1.jpg" alt="">
									</div>
									<ul class="tags">
										<li><a href="#">Lifestyle</a></li>
									</ul>
							...
							<div class="single-relavent-post row align-items-center">
								<div class="col-lg-5 post-left">
									<div class="feature-img relative">
										<div class="overlay overlay-bg"></div>
										<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/r2.jpg" alt="">
									</div>
									<ul class="tags">
										<li><a href="#">Science</a></li>
									</ul>
							...
							<div class="single-relavent-post row align-items-center">
								<div class="col-lg-5 post-left">
									<div class="feature-img relative">
										<div class="overlay overlay-bg"></div>
										<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/r3.jpg" alt="">
									</div>
									<ul class="tags">
										<li><a href="#">Travel</a></li>
									</ul>
					...
					<div class="sidebars-area">
						<div class="single-sidebar-widget editors-pick-widget">
							...
							<div class="editors-pick-post">
								<div class="feature-img-wrap relative">
									<div class="feature-img relative">
										<div class="overlay overlay-bg"></div>
										<img class="{{base_url('assets/img')}}-fluid" src="{{base_url('assets/img')}}/e1.jpg" alt="">
									</div>
									<ul class="tags">
										<li><a href="#">Travel</a></li>
									</ul>
						...
						<div class="single-sidebar-widget most-popular-widget">
							...
							<div class="single-list flex-row d-flex">
								<div class="thumb">
									<img src="{{base_url('assets/img')}}/m1.jpg" alt="">
								</div>
								<div class="details">
									<a href="image-post.html">
							...
							<div class="single-list flex-row d-flex">
								<div class="thumb">
									<img src="{{base_url('assets/img')}}/m2.jpg" alt="">
								</div>
								<div class="details">
									<a href="image-post.html">
							...
							<div class="single-list flex-row d-flex">
								<div class="thumb">
									<img src="{{base_url('assets/img')}}/m3.jpg" alt="">
								</div>
								<div class="details">
									<a href="image-post.html">
							...
							<div class="single-list flex-row d-flex">
								<div class="thumb">
									<img src="{{base_url('assets/img')}}/m4.jpg" alt="">
								</div>
								<div class="details">
									<a href="image-post.html">
										<h6>5 Tips For Offshore Soft
