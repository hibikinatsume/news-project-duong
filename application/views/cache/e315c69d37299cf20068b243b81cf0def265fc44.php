<?php /* /var/www/articles/application/views/master/types/types.blade.php */ ?>
<?php
/**
 * Created by PhpStorm.
 * User: hana
            ...
            <table class="table table-bordered tree" width="" style="text-transform: uppercase">
                ...
                <?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><a href='#' class='btn  mr-2 edit' data-toggle='modal' data-target='#modal-04' data-id='<?php echo e($value->id); ?>' style='background-color: #CDDC39; color: #fff!important;'><i class='fas fa-pencil-alt'></i></a>
                            <a href=" <?php echo e(base_url('index.php/types/remove_category/' . $value->id)); ?> " class='btn' style='background-color: #E91E63 ; color: #fff!important;'><i class='fas fa-times'></i></a>
                        </td>
                    </tr>
