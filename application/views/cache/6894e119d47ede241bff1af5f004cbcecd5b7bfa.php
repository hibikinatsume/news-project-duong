<?php /* /var/www/articles/application/views/users/main.blade.php */ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <!-- font-awesome -->
    <link href="<?php echo e(base_url('assets')); ?>/fonts/font-awesome/font-awesome.min.css" rel="stylesheet">
    <!-- Mobile Menu Style -->
    <link href="<?php echo e(base_url('assets')); ?>/css/mobile-menu.css" rel="stylesheet">

    <!-- Owl carousel -->
    <link href="<?php echo e(base_url('assets')); ?>/css/owl.carousel.css" rel="stylesheet">
    <link href="<?php echo e(base_url('assets')); ?>/css/owl.theme.default.min.css" rel="stylesheet">
    <!-- Theme Style -->
                ...
                <div class="container">
                    <div class="header-section">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="logo">
                                    <a href="index.html"><img src="<?php echo e(base_url('assets')); ?>/img/logo.png" alt="Tech NewsLogo"></a>
                                </div>
                                <!-- Logo Section -->
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="feature_article_wrapper">
                                <div class="feature_article_img">
                                    <img class="img-responsive top_static_article_img" src="<?php echo e(base_url('assets')); ?>/img/feature-top.jpg"
                                         alt="feature-top">
                                </div>
                                <!-- feature_article_img -->
                        ...
                        <div class="col-md-5">
                            <div class="feature_static_wrapper">
                                <div class="feature_article_img">
                                    <img class="img-responsive" src="<?php echo e(base_url('assets')); ?>/img/feature-static1.jpg" alt="feature-top">
                                </div>
                                <!-- feature_article_img -->
                        ...
                        <div class="col-md-5">
                            <div class="feature_static_last_wrapper">
                                <div class="feature_article_img">
                                    <img class="img-responsive" src="<?php echo e(base_url('assets')); ?>/img/feature-static2.jpg" alt="feature-top">
                                </div>
                                <!-- feature_article_img -->
            ...
            <section id="category_section" class="category_section">
                    ...
                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="top_article_img">
                                                <a href="single.html" target="_self"><img class="img-responsive"
                                                                                          src="<?php echo e(base_url('assets')); ?>/img/cat-mobi-left-1.jpg" alt="feature-top">
                                                </a>
                                            </div>
                                            <!----top_article_img------>
                                        </div>
                                ...
                                <div class="category_article_wrapper">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#"><img class="media-object" src="<?php echo e(base_url('assets')); ?>/img/cat-mobi-sm1.jpg"
                                            ...
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#"><img class="media-object" src="<?php echo e(base_url('assets')); ?>/img/cat-mobi-sm3.jpg"
                                                                     alt="Generic placeholder image"></a>
                                                </div>
                                                <div class="media-body">
                                                    <span class="tag purple">Mobile</span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#"><img class="media-object" src="<?php echo e(base_url('assets')); ?>/img/cat-mobi-sm2.jpg"
                                                                     alt="Generic placeholder image"></a>
                                                </div>
                                                <div class="media-body">
                                                    <span class="tag purple">Mobile</span>
                                            ...
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#"><img class="media-object" src="<?php echo e(base_url('assets')); ?>/img/cat-mobi-sm4.jpg"
                                                                     alt="Generic placeholder image"></a>
                                                </div>
                                                <div class="media-body">
                                                    <span class="tag purple">Mobile</span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="category_article_body">
                                                <div class="top_article_img">
                                                    <a href="single.html" target="_self"><img class="img-responsive" src="<?php echo e(base_url('assets')); ?>/img/tab_top1.jpg"
                                                                                              alt="feature-top">
                                                    </a>
                                                </div>
                                                <!-- top_article_img -->
                                            ...
                                            <div class="category_article_body">
                                                <div class="top_article_img">
                                                    <a href="single.html" target="_self">
                                                        <img class="img-responsive" src="<?php echo e(base_url('assets')); ?>/img/tab_top2.jpg" alt="feature-top">
                                                    </a>
                                                </div>
                                                <!-- top_article_img -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="category_article_body">
                                                <div class="top_article_img">
                                                    <a href="single.html" target="_self">
                                                        <img class="img-responsive" src="<?php echo e(base_url('assets')); ?>/img/gad_top1.jpg" alt="feature-top">
                                                    </a>
                                                </div>
                                                <!-- top_article_img -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="category_article_body">
                                                <div class="top_article_img">
                                                    <img class="img-responsive" src="<?php echo e(base_url('assets')); ?>/img/gad_top2.jpg" alt="feature-top">
                                                </div>
                                                <!-- top_article_img -->
                                ...
                                <div class="category_article_wrapper">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="top_article_img">
                                                <a href="single.html" target="_self">
                                                    <img class="img-responsive" src="<?php echo e(base_url('assets')); ?>/img/cam_left1.jpg" alt="feature-top">
                                                </a>
                                            </div>
                                            <!-- top_article_img -->
                                ...
                                <div class="category_article_wrapper">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="top_article_img">
                                                <a href="single.html" target="_self">
                                                    <img class="img-responsive" src="<?php echo e(base_url('assets')); ?>/img/cam_left2.jpg" alt="feature-top">
                                                </a>
                                            </div>
                                            <!-- top_article_img -->
                                ...
                                <div class="category_article_wrapper">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="top_article_img">
                                                <a href="single.html" target="_self">
                                                    <img class="img-responsive" src="<?php echo e(base_url('assets')); ?>/img/cam_left3.jpg" alt="feature-top">
                                                </a>
                                            </div>
                                            <!-- media_social -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="category_article_body">
                                                <div class="top_article_img">
                                                    <a href="single.html" target="_self">
                                                        <img class="img-responsive" src="<?php echo e(base_url('assets')); ?>/img/design_top1.jpg" alt="feature-top">
                                                    </a>
                                                </div>
                                                <!-- top_article_img -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="category_article_body">
                                                <div class="top_article_img">
                                                    <a href="single.html" target="_self">
                                                        <img class="img-responsive" src="<?php echo e(base_url('assets')); ?>/img/design_top2.jpg" alt="feature-top">
                                                    </a>
                                                </div>
                                                <!-- top_article_img -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="category_article_body">
                                                <div class="top_article_img">
                                                    <a href="single.html" target="_self">
                                                        <img class="img-responsive" src="<?php echo e(base_url('assets')); ?>/img/design_top3.jpg" alt="feature-top">
                                                    </a>
                                                </div>
                                                <!-- top_article_img -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="category_article_body">
                                                <div class="top_article_img">
                                                    <img class="img-responsive" src="<?php echo e(base_url('assets')); ?>/img/design_top4.jpg" alt="feature-top">
                                                </div>
                                                <!-- top_article_img -->
                        ...
                        <div class="col-md-4">
                            <div class="widget">
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#"><img class="media-object" src="<?php echo e(base_url('assets')); ?>/img/pop_right1.jpg" alt="Generic placeholder image"></a>
                                    </div>
                                    <div class="media-body">
                ...
                <span>
                    ...
                    <a href="single.html" target="_self"><i class="fa fa-comments-o"></i>4</a> Comments
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#"><img class="media-object" src="<?php echo e(base_url('assets')); ?>/img/pop_right2.jpg" alt="Generic placeholder image"></a>
                                    </div>
                                    <div class="media-body">
                                        <h3 class="media-heading">
                ...
                <span>
                    ...
                    <a href="single.html" target="_self"><i class="fa fa-comments-o"></i>4</a> Comments
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#"><img class="media-object" src="<?php echo e(base_url('assets')); ?>/img/pop_right3.jpg" alt="Generic placeholder image"></a>
                                    </div>
                                    <div class="media-body">
                                        <h3 class="media-heading">
                ...
                <span>
                    ...
                    <a href="single.html" target="_self"><i class="fa fa-comments-o"></i>4</a> Comments
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#"><img class="media-object" src="<?php echo e(base_url('assets')); ?>/img/pop_right4.jpg" alt="Generic placeholder image"></a>
                                    </div>
                                    <div class="media-body">
                                        <h3 class="media-heading">
                ...
                <span>
                    ...
                    <a href="single.html" target="_self"><i class="fa fa-comments-o"></i>4</a> Comments
                            ...
                            <div class="widget hidden-xs m30">
                                <img class="img-responsive adv_img" src="<?php echo e(base_url('assets')); ?>/img/right_add1.jpg" alt="add_one">
                                <img class="img-responsive adv_img" src="<?php echo e(base_url('assets')); ?>/img/right_add2.jpg" alt="add_one">
                                <img class="img-responsive adv_img" src="<?php echo e(base_url('assets')); ?>/img/right_add3.jpg" alt="add_one">
                                <img class="img-responsive adv_img" src="<?php echo e(base_url('assets')); ?>/img/right_add4.jpg" alt="add_one">
                            </div>
                            <!-- Advertisement -->

                            <div class="widget hidden-xs m30">
                                <img class="img-responsive widget_img" src="<?php echo e(base_url('assets')); ?>/img/right_add5.jpg" alt="add_one">
                            </div>
                            <!-- Advertisement -->
                ...
                <i class="fa fa-star-half-full"></i>
                            ...
                            <div class="widget hidden-xs m30">
                                <img class="img-responsive widget_img" src="<?php echo e(base_url('assets')); ?>/img/right_add6.jpg" alt="add_one">
                            </div>
                            <!-- Advertisement -->
                            ...
                            <div class="widget m30">
                                ...
                                <div class="widget_body"><img class="img-responsive left" src="<?php echo e(base_url('assets')); ?>/img/editor.jpg"
                            ...
                            <div class="widget hidden-xs m30">
                                <img class="img-responsive add_img" src="<?php echo e(base_url('assets')); ?>/img/right_add7.jpg" alt="add_one">
                                <img class="img-responsive add_img" src="<?php echo e(base_url('assets')); ?>/img/right_add7.jpg" alt="add_one">
                                <img class="img-responsive add_img" src="<?php echo e(base_url('assets')); ?>/img/right_add7.jpg" alt="add_one">
                                <img class="img-responsive add_img" src="<?php echo e(base_url('assets')); ?>/img/right_add7.jpg" alt="add_one">
                            </div>
                            ...
                            <div class="widget m30">
                                ...
                                <div class="widget_body"><img class="img-responsive left" src="<?php echo e(base_url('assets')); ?>/img/reader.jpg"
                                                              alt="Generic placeholder image">
                            ...
                            <div class="widget hidden-xs m30">
                                <img class="img-responsive widget_img" src="<?php echo e(base_url('assets')); ?>/img/podcast.jpg" alt="add_one">
                            </div>
                            <!--Advertisement-->
                        </div>
                        <!-- Right Section -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="logo footer-logo">
                                <a title="fontanero" href="index.html">
                                    <img src="<?php echo e(base_url('assets')); ?>/img/tech_about.jpg" alt="technews">
                                </a>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <a href="#"><img class="media-object" src="<?php echo e(base_url('assets')); ?>/img/editor_pic1.jpg"
                                                     alt="Generic placeholder image"></a>
                                </div>
                                <div class="media-body">
                                    <h3 class="media-heading">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <a href="#"><img class="media-object" src="<?php echo e(base_url('assets')); ?>/img/editor_pic2.jpg"
                                                     alt="Generic placeholder image"></a>
                                </div>
                                <div class="media-body">
                                    <h3 class="media-heading">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <a href="#"><img class="media-object" src="<?php echo e(base_url('assets')); ?>/img/editor_pic3.jpg"
                                                     alt="Generic placeholder image"></a>
                                </div>
                                <div class="media-body">
                                    <h3 class="media-heading">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget_photos">
                                <img class="img-thumbnail" src="<?php echo e(base_url('assets')); ?>/img/tech_photo1.jpg" alt="Tech Photos">
                                <img class="img-thumbnail" src="<?php echo e(base_url('assets')); ?>/img/tech_photo2.jpg" alt="Tech Photos">
                                <img class="img-thumbnail" src="<?php echo e(base_url('assets')); ?>/img/tech_photo3.jpg" alt="Tech Photos">
                                <img class="img-thumbnail" src="<?php echo e(base_url('assets')); ?>/img/tech_photo4.jpg" alt="Tech Photos">
                                <img class="img-thumbnail" src="<?php echo e(base_url('assets')); ?>/img/tech_photo5.jpg" alt="Tech Photos">
                                <img class="img-thumbnail" src="<?php echo e(base_url('assets')); ?>/img/tech_photo6.jpg" alt="Tech Photos">
                                <img class="img-thumbnail" src="<?php echo e(base_url('assets')); ?>/img/tech_photo7.jpg" alt="Tech Photos">
                                <img class="img-thumbnail" src="<?php echo e(base_url('assets')); ?>/img/tech_photo8.jpg" alt="Tech Photos">
                                <img class="img-thumbnail" src="<?php echo e(base_url('assets')); ?>/img/tech_photo9.jpg" alt="Tech Photos">
                                <img class="img-thumbnail" src="<?php echo e(base_url('assets')); ?>/img/tech_photo10.jpg" alt="Tech Photos">
                                <img class="img-thumbnail" src="<?php echo e(base_url('assets')); ?>/img/tech_photo11.jpg" alt="Tech Photos">
                                <img class="img-thumbnail" src="<?php echo e(base_url('assets')); ?>/img/tech_photo12.jpg" alt="Tech Photos">
                            </div>
...
<!-- jquery Core-->
<script src="<?php echo e(base_url('assets')); ?>/js/jquery-2.1.4.min.js"></script>

<!-- Bootstrap -->
<script src="<?php echo e(base_url('assets')); ?>/js/bootstrap.min.js"></script>

<!-- Theme Menu -->
<script src="<?php echo e(base_url('assets')); ?>/js/mobile-menu.js"></script>
