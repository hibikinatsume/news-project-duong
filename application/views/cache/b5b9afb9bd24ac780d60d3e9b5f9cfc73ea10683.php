<?php /* /var/www/codeigniter/application/views/home/detail.blade.php */ ?>
<?php
/**
 * Created by PhpStorm.
 * User: hana
						...
						<div class="post-content">
							...
							<?= $news_detail->content ?>
								...
								<div class="related-posts clearfix">
									...
									<div class="row">
									<?php $__currentLoopData = $relation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $reItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<!-- Single Blog Post -->
								...
								<div class="comment_area clearfix">
									...
									<ol id="comment-display">
										<?php $__currentLoopData = $cm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keys => $comItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php if($comItem->status == 1 && $comItem->id_rep == null): ?>
												<li class="single_comment_area">
													<div class="comment-wrapper d-flex">
														<!-- Comment Meta -->
														<div class="comment-author">
															<?php if($comItem->id_google != 0): ?>
													...
													<ol class="children">
													<?php $__currentLoopData = $comItem->con; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ks => $repItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<?php if($repItem->status == 1): ?>
																	<li class="single_comment_area">
																		<div class="comment-wrapper d-flex">
																			<!-- Comment Meta -->
																			<div class="comment-author">
																				<?php if($repItem->id_google != 0): ?>
								...
								<?php if(isset($_SESSION['id'])): ?>
									<?php if($checkCM['count'] >= $checkCM['all']): ?>
								...
								<div class="leave-comment-area clearfix">
									<div class="comment-form">
										<?php if(in_array('0',$arr->comments) || in_array('2',$arr->comments)): ?>
