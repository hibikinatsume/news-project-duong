<?php /* C:\xampp\htdocs\articles\application\views/users/category.blade.php */ ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="news-tracker-wrap">
                            <h6><a href="<?php echo e(base_url("index.php/index")); ?>">Trang chủ </a>  <span class="lnr lnr-arrow-right"></span> <a href="<?php echo e(base_url("index.php/index/category/".$category->id)); ?>"><?php echo e($category->name); ?></a></h6>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-8 post-list">
                        ...
                        <div class="latest-post-wrap">
                            <h3 class="cat-title"><?php echo e($category->name); ?></h3>
                            <div class="append">
