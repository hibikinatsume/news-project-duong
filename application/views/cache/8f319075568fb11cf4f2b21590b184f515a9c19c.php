<?php /* /var/www/codeigniter/application/views/home/category.blade.php */ ?>
<?php
/**
 * Created by PhpStorm.
 * User: hana
			...
			<div class="row justify-content-center">
				...
				<div class="col-12 col-lg-8">
					<div class="blog-posts-area">
						...
						<?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cateItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if($cateItem->status == 1): ?>
								<!-- Single Blog Post -->
