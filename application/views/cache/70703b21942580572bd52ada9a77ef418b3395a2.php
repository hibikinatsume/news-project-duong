<?php /* /var/www/codeigniter/application/views/master/layouts/main.blade.php */ ?>
<?php
/**
 * Created by PhpStorm.
 * User: hana
...
<head>
	...
	<title>Hana</title>
	<link rel="icon" type="image/png" href="<?= base_url('assets/img/myimg/ows-1.png') ?>" sizes="192x192">
	<!-- General CSS Files -->
	...
	<div class="main-wrapper main-wrapper-1">
		...
		<div class="main-sidebar sidebar-style-2">
			<aside id="sidebar-wrapper">
				...
				<ul class="sidebar-menu">
					...
					<?php if(in_array('0',$arr->users) || in_array('1',$arr->users)): ?>
						<li class="nav-item dropdown ">
							...
							<ul class="dropdown-menu">
								...
								<?php endif; ?>
								<?php if(in_array('0',$arr->users) || in_array('2',$arr->users)): ?>
								<li><a class="nav-link" href="<?= base_url('index.php/users/view_add') ?>">Thêm người dùng</a></li>
								<?php endif; ?>
							</ul>
						</li>
					<?php endif; ?>
					<?php if(in_array('0',$arr->news) || in_array('1',$arr->news)): ?>
						<li class="nav-item dropdown ">
							...
							<ul class="dropdown-menu">
								...
								<?php endif; ?>
								<?php if(in_array('0',$arr->news) || in_array('2',$arr->news)): ?>
									<li><a class="nav-link" href="<?= base_url('index.php/posts/view_write') ?>">Viết bài</a></li>
								<?php endif; ?>
							</ul>
						</li>
					<?php endif; ?>
					<?php if(in_array('0',$arr->category) || in_array('1',$arr->category)): ?>
						<li class="nav-item dropdown ">
					...
					<?php endif; ?>
					<?php if(in_array('0',$arr->permission) || in_array('1',$arr->permission)): ?>
						<li class="nav-item dropdown ">
							...
							<ul class="dropdown-menu">
								...
								<?php endif; ?>
								<?php if(in_array('0',$arr->permission) || in_array('2',$arr->permission)): ?>
		...
		<div class="main-content">
			<section class="section">
				<div class="section-header"><h1><?php echo $__env->yieldContent('header'); ?></h1></div>
				<div class="section-body">
					<div class="section-title">
						<?php echo $__env->yieldContent('title'); ?>
					</div>
					<p class="section-lead">
						<?php echo $__env->yieldContent('lead'); ?>
					</p>
		...
		<footer class="main-footer">
			<div class="footer-left">
				Copyright &copy; 2019 <div class="bullet"></div> OWS News
			</div>
